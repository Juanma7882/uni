...
class App(customtkinter.CTk):
    ...
    def btn_comenzar_ingreso_on_click(self):
        ...
        while True:
            numeros_ingresados = prompt(title="utn",prompt="ingrese un numero")
            
            if numeros_ingresados == None:
                break
            numeros_ingresados = float(numeros_ingresados)
            if bandera1 == True or numeros_ingresados  > numero_max:
                numero_max = numeros_ingresados
            if bandera1 == True or numeros_ingresados < numero_min:
                numero_min = numeros_ingresados   
                bandera1 = False
