...
class App(customtkinter.CTk):
    ...
    def btn_validar_letra_on_click(self):
        texto_ingresado = prompt(title="verificasion",prompt="ingrese letra")
        while texto_ingresado != "U" and texto_ingresado != "T" and texto_ingresado !="N":
            alert(title="UTN",message= "reingrese letra")
            texto_ingresado = prompt("",prompt="ingrese letra correcta")
        alert(title="",message=f"letra {texto_ingresado} correcta") 
        pass
