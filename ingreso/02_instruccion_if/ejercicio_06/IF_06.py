...
class App(customtkinter.CTk):
    ...
    def btn_mostrar_on_click(self):
        numero_ingresado = self.txt_edad.get()
        numero_ingresado = int(numero_ingresado)
        if (numero_ingresado >13 and numero_ingresado <18):
            mensaje = ("adolecente")
        elif (numero_ingresado >9 and numero_ingresado <14):
            mensaje = ("pre adolecente")
        elif ( numero_ingresado >=0 and numero_ingresado <10):
            mensaje = ("niño")              
