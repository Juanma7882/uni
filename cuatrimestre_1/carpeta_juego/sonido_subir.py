...
class Pausa:
    ...
    def iniciar(self):
        ...
        while run:
            ...
            dibujar_cuadrado_con_texto(self.screen,((self.width//2)-82),400,25,45,3,color,"-",None,45,"purple")
            dibujar_cuadrado_con_texto(self.screen,((self.width//2)+40),400,25,45,3,color,"+",None,45,"purple")
